#!/usr/bin/env python3
"""Publish the explicitly approved Dragon Ball Reel and write an audit receipt."""
...
VIDEO = Path(
    "artifacts/approved/dragonball-batch-v1/"
    "dragonball-master-approved.mp4"
)
EXPECTED_SHA256 = "4cb7f4d63a40dcee709cf9ff34a82faddfd9300d1c8a61d5892765f328bd5044"
APPROVAL_TOKEN = "dragonball-v1-instagram-approved-2026-07-30"
R2_VIDEO_KEY = f"approved/instagram/dragonball-v1-{EXPECTED_SHA256[:16]}.mp4"
R2_LEDGER_KEY = "publication-ledger/instagram/dragonball-v1.json"
RECEIPT = Path("artifacts/instagram-dragonball-v1-publication-result.json")
CAPTION = """Más de 30 personajes llegan a Dragon Ball: Sparking! ZERO. ⚡

Nuevos luchadores, cuatro escenarios y un modo individual.

¿Cuál vas a entrenar primero?

Fuente audiovisual: tráiler oficial de Bandai Namco Entertainment. Fragmentos breves transformados con narración, contexto y edición de La Estratosférica.

Fuente: https://www.youtube.com/watch?v=SZhl5-ag0tA

#DragonBallSparkingZero #DragonBall #GamingLatam #Videojuegos #LaEstratosférica"""
...
def main() -> None:
    ...
    pending = {
        ...
        "source_url": "https://www.youtube.com/watch?v=SZhl5-ag0tA",
